...
//@interface LoveMyBabyObject : NSObject
//@end

@interface LoveMyBabyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LoveMyBabyObject class]])
		{
			for (NSString *key in [[(LoveMyBabyObject*)o modules] allKeys])
			{
