...
// in simulator we redefine to format for LoveMyBaby Developer console
...
{\
	NSString * exceptionName = [@"org.lovemybaby." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lovemybaby";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILoveMyBabyNativeItemNone = -1, 
	UILoveMyBabyNativeItemSpinner = -2,
	UILoveMyBabyNativeItemProgressBar = -3,
	
	UILoveMyBabyNativeItemSlider = -4,
	UILoveMyBabyNativeItemSwitch = -5,
	UILoveMyBabyNativeItemMultiButton = -6,
	UILoveMyBabyNativeItemSegmented = -7,
	
	UILoveMyBabyNativeItemTextView = -8,
	UILoveMyBabyNativeItemTextField = -9,
	UILoveMyBabyNativeItemSearchBar = -10,
	
	UILoveMyBabyNativeItemPicker = -11,
	UILoveMyBabyNativeItemDatePicker = -12,
	
	UILoveMyBabyNativeItemInfoLight = -13,
	UILoveMyBabyNativeItemInfoDark = -14,
	
	UILoveMyBabyNativeItemDisclosure = -15,
	
	UILoveMyBabyNativeItemContactAdd = -16
};
